...
class AllAdminNotificationsPage extends StatelessWidget {
  const AllAdminNotificationsPage({super.key});
          ...
          children: [
            ShadowedBox(
              child: Column(
                ...
                children: [
                  const SectionTitle(text: 'All Admin Notifications'),
                  const Divider(
                    height: 1,
                    color: kBorderColor,
                  ),
                    ...
                    child: Column(
                      children: [
                        SeparatedRow(
                          ...
                          children: const [
                            SearchButton(hintText: 'Notification title'),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            SeparatedRow(
                              children: const [
                                // FilterButton.type(),
                                PrimaryButton(label: 'Send Notifications'),
                              ],
                              separatorBuilder: () => const SizedBox(width: 20),
                            ),
                          ],
                  ...
                  CustomTable(
                    ...
                    rowsData: [
                      [
                        ...
                        MainTextData(
                          text: 'This is the very first notification',
                          textColor: kPrimaryColor,
                          textOverflow: TextOverflow.ellipsis,
                        ),
                        MainTextData(text: 'Business listing owners'),
                        MainSubTextData(
                          mainText: '88-88-8888',
                          subText: '88:88 AM',
