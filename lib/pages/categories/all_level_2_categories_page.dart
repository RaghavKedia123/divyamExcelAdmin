...
class AllLevel2CategoriesPage extends StatelessWidget {
  const AllLevel2CategoriesPage({super.key});
      ...
      children: [
        ShadowedBox(
          child: Column(
            ...
            children: [
              const SectionTitle(text: 'Level 2 Categories'),
              const Divider(
                height: 1,
                color: kBorderColor,
              ),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SeparatedRow(
                      children: const [
                        // FilterButton(
                        //     text: 'Select Level 1 Category', width: 250),
                        PrimaryButton(label: 'Add New Level 2 Category'),
                      ],
