...
class PendingComplaintsPage extends StatelessWidget {
      ...
      children: [
        ShadowedBox(
          child: Column(
            ...
            children: [
              const SectionTitle(text: 'Pending Complaints'),
              const Divider(
                height: 1,
                color: kBorderColor,
              ),
              ...
              const Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    PrimaryButton(label: 'Start Resolving Complaints')
                  ],
                ),
              ),
              const Divider(
              ...
              CustomTable(
                ...
                rowsData: [
                  [
                    ...
                    MainTextData(text: 'Religiously hateful material'),
                    MainTextData(text: 'Offer - Regular (B2C)'),
                    MainTextData(
        ...
        ShadowedBox(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const SectionTitle(text: 'Under Process Complaints'),
              const Divider(
                height: 1,
                color: kBorderColor,
              ),
              ...
              CustomTable(
                ...
                rowsData: [
                  [
                    MainTextData(text: '101'),
                    MainTextData(
                      text: 'Religiously hateful material',
