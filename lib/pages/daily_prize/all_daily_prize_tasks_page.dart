...
class AllDailyPrizeTasksPage extends StatelessWidget {
  const AllDailyPrizeTasksPage({super.key});
      ...
      children: [
        ShadowedBox(
          child: Column(
            ...
            children: [
              const SectionTitle(text: 'Daily Prize Tasks'),
              const Divider(
                height: 1,
                color: kBorderColor,
              ),
              const Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    PrimaryButton(label: 'Add New Task'),
                  ],
                ),
              ),
              const Divider(
              ...
              CustomTable(
                ...
                rowsData: [
                  [
                    ...
                    MainTextData(text: 'Get most number of likes'),
                    const ActionIcon(),
                  ],
                  [
                    MainTextData(text: '101'),
                    MainTextData(text: 'Get most number of shares'),
                    const ActionIcon(),
                  ],
                  [
                    MainTextData(text: '101'),
                    MainTextData(text: 'Get most number of views'),
                    const ActionIcon(),
                  ],
                ],
              ),
