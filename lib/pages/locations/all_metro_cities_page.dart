...
class AllMetroCitiesPage extends StatelessWidget {
  const AllMetroCitiesPage({super.key});
      ...
      children: [
        ShadowedBox(
          child: Column(
            ...
            children: [
              const SectionTitle(text: 'Metro Cities'),
              const Divider(
                height: 1,
                color: kBorderColor,
              ),
                  ...
                  children: [
                    ...
                    SeparatedRow(
                      children: const [
                        ...
                        PrimaryButton(label: 'Add New Metro City'),
                      ],
              ...
              CustomTable(
                ...
                rowsData: [
                  [
                    ...
                    MainTextData(text: 'Mumbai'),
                    MainTextData(text: 'Andhra Pradesh'),
                    MainTextData(text: '9999'),
                    const ActionIcon(),
                  ],
                  [
                    MainTextData(text: '101'),
