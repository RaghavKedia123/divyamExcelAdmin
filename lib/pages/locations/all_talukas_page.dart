...
class AllTalukasPage extends StatelessWidget {
  const AllTalukasPage({super.key});
      ...
      children: [
        ShadowedBox(
          child: Column(
            ...
            children: [
              const SectionTitle(text: 'Talukas'),
              const Divider(
                height: 1,
                color: kBorderColor,
              ),
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SeparatedRow(
                      children: const [
                        // FilterButton(text: 'Select state', width: 200),
                        // FilterButton(text: 'Select district', width: 200),
                        PrimaryButton(label: 'Add New Taluka'),
                      ],
              ...
              CustomTable(
                ...
                rowsData: [
                  [
                    ...
                    MainTextData(text: '9876543210'),
                    MainTextData(text: 'Khamgaon'),
                    MainTextData(text: 'Buldhana'),
                    MainTextData(text: 'Maharashtra'),
                    const ActionIcon(),
                  ],
                  [
                    MainTextData(text: '101'),
