...
class UsersPerformanceReportPage extends StatelessWidget {
  const UsersPerformanceReportPage({super.key});
      ...
      children: [
        ShadowedBox(
          child: Column(
            ...
            children: [
              const SectionTitle(text: 'Users Performance Report'),
              const Divider(
                height: 1,
                color: kBorderColor,
              ),
              ...
              CustomTable(
                ...
                rowsData: [
                  [
                    ...
                    MainTextData(text: '72750'),
                    MainTextData(text: '16792'),
                    MainTextData(text: '₹ 50135.00'),
                    MainTextData(text: '532'),
                  ],
                  [
                    MainTextData(text: '102'),
                    MainTextData(text: 'Shashwat Dharangaonkar'),
                    MainTextData(text: '72750'),
                    MainTextData(text: '16792'),
                    MainTextData(text: '₹ 50135.00'),
