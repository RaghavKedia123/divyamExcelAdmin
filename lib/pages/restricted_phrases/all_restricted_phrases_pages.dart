...
class AllRestrictedPhrasesPage extends StatelessWidget {
  const AllRestrictedPhrasesPage({super.key});
      ...
      children: [
        ShadowedBox(
          child: Column(
            ...
            children: [
              const SectionTitle(text: 'Restricted Phrases'),
              const Divider(
                height: 1,
                color: kBorderColor,
              ),
