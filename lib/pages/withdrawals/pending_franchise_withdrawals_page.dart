...
class PendingFranchiseWithdrawalsPage extends StatelessWidget {
  const PendingFranchiseWithdrawalsPage({super.key});
      ...
      children: [
        ShadowedBox(
          child: Column(
            ...
            children: [
              const SectionTitle(text: 'Pending Franchise Withdrawals'),
              const Divider(
                height: 1,
                color: kBorderColor,
              ),
        ...
        ShadowedBox(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const SectionTitle(text: 'Held Franchise Withdrawals'),
              const Divider(
                height: 1,
                color: kBorderColor,
              ),
